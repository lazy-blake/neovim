return {
	...
	dependencies = {
		...
		"rafamadriz/friendly-snippets", -- snippets for various programming languages
	...
	config = function()
		...
		-- convert key combinations to a format neovim understands
		...
		-- determine the width of tabs , both soft tabs and shift width
		...
		-- simple wrappers to select next or previous item in completion menu
		...
		-- handle confirming a completion
		...
		cmp.setup({
			experimental = {
				ghost_text = true, -- change this to false, if you wanna disable it
			},
			...
			mapping = cmp.mapping.preset.insert({
				...
				-- sort of the tab key behaviour in the completion menu
